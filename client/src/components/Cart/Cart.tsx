...
class Cart extends React.Component<Props, State> {
  ...
  componentDidUpdate() {
    console.log('Updated')
    this.state.total = this.props.cart.items.reduce((acc, item) => acc += item.product.info.price * item.quantity!, 0)  
            ...
            <div className="info">
              ...
              <p>
                ...
                <span className="total">
                  {
                  cartExists ? 
                  numeral(cart.items.reduce((acc, item) => acc += item.product.info.price * item.quantity!, 0)).format('$0,0.00') : 
